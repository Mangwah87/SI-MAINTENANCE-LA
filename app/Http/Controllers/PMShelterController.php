    ...
    public function store(Request $request)
    {
        try {
            $validated = $request->validate([
                ...
                'kondisi_ruangan_photos.*' => 'nullable|image|mimes:jpg,jpeg,png|max:10000',
                'kondisi_kunci_photos.*' => 'nullable|image|mimes:jpg,jpeg,png|max:10000',
                'layout_tata_ruang_photos.*' => 'nullable|image|mimes:jpg,jpeg,png|max:10000',
                'kontrol_keamanan_photos.*' => 'nullable|image|mimes:jpg,jpeg,png|max:10000',
                'aksesibilitas_photos.*' => 'nullable|image|mimes:jpg,jpeg,png|max:10000',
                'aspek_teknis_photos.*' => 'nullable|image|mimes:jpg,jpeg,png|max:10000',

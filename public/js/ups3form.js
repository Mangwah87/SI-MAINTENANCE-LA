// ============================================================================
// UPS3 FORM CAMERA HANDLER - WITA VERSION
  ...
  function init() {
    ...
    async function getLocationName(lat, lon) {
      ...
      try {
        ...
        // Gunakan LocationIQ API (lebih akurat, tetap free)
        // Atau bisa pakai Google Geocoding jika ada API key
        ...
        if (data.address) {
          ...
          // Prioritas: Jalan → Kelurahan/Desa → Kecamatan → Kota
          if (addr.road) {

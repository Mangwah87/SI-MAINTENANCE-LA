    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Preventive Maintenance 3 Phase UPS') }}
            </h2>
            <a href="{{ route('ups3.create') }}"
                            ...
                            <div class="border rounded-lg p-4 bg-gray-50 shadow-sm">
                                ...
                                <div class="mb-3 pb-3 border-b">
                                    <div class="grid grid-cols-2 gap-2 text-xs">
                                        ...
                                        <div>
                                            <p class="text-gray-500">Reg. Number:</p>
                                            <p class="font-medium text-gray-900">{{ $maintenance->reg_number ?? '-' }}</p>
                                        </div>
                                        <div>
                                            <p class="text-gray-500">S/N:</p>
                                            <p class="font-medium text-gray-900">{{ $maintenance->sn ?? '-' }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-4 gap-2">
                                    <a href="{{ route('ups3.show', $maintenance) }}"
                                    ...
                                    <a href="{{ route('ups3.edit', $maintenance) }}"
                                    ...
                                    <a href="{{ route('ups3.print', $maintenance) }}"

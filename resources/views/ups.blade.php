<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('ups.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-medium text-sm">
                + Add New
            </a>
        </div>
    </x-slot>
                                ...
                                <tr class="hover:bg-blue-50 transition duration-150">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex justify-end gap-3">
                                            <a href="{{ route('ups.show', $maintenance->id) }}" class="text-blue-600 hover:text-blue-800 font-medium text-sm">View</a>
                                            <a href="{{ route('ups.edit', $maintenance->id) }}" class="text-orange-600 hover:text-orange-800 font-medium text-sm">Edit</a>
                ...
                @foreach($maintenances as $maintenance)
                    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4 hover:shadow-md transition">
                        ...
                        <div class="flex gap-2 text-xs">
                            <a href="{{ route('ups.show', $maintenance->id) }}" class="text-blue-600 hover:text-blue-800 font-medium">View</a>
                            <span class="text-gray-400">/</span>
                            <a href="{{ route('ups.edit', $maintenance->id) }}" class="text-orange-600 hover:text-orange-800 font-medium">Edit</a>
                            <span class="text-gray-400">/</span>

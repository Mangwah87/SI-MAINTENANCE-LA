    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Buat Permohonan Tindak Lanjut PM') }}
            </h2>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('pm-permohonan.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea name="permasalahan" 
                                      ...
                                      required>{{ old('permasalahan') }}</textarea>
                            @error('permasalahan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="usulan_tindak_lanjut" 
                                      ...
                                      placeholder="Jelaskan usulan tindak lanjut..."
                                      required>{{ old('usulan_tindak_lanjut') }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('ditujukan_department') }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                           placeholder="Opsional">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('ditujukan_sub_department') }}"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                           placeholder="Opsional">
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-4">
                                <label class="inline-flex items-center">
                                    <input type="radio" 
                                           ...
                                           value="email" 
                                           {{ old('diinformasikan_melalui', 'email') == 'email' ? 'checked' : '' }}
                                ...
                                <label class="inline-flex items-center">
                                    <input type="radio" 
                                           name="diinformasikan_melalui" 
                                           value="fax" 
                                           {{ old('diinformasikan_melalui') == 'fax' ? 'checked' : '' }}
                                           class="rounded-full border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                ...
                                <label class="inline-flex items-center">
                                    <input type="radio" 
                                           name="diinformasikan_melalui" 
                                           value="hardcopy" 
                                           {{ old('diinformasikan_melalui') == 'hardcopy' ? 'checked' : '' }}
                                           class="rounded-full border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                    <span class="ml-2 text-sm text-gray-700">Hardcopy</span>
                                </label>
                            </div>
                            @error('diinformasikan_melalui')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>

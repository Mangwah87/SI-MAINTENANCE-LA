                                ...
                                @foreach($centralsByArea as $area => $centrals)
                                    <optgroup label="AREA {{ $area }}">
                                        @foreach($centrals as $central)
                                            @php
                                                // [PENTING] Kita harus menyusun string value agar sama persis dengan format teks di Database Grounding
                                                // Format berdasarkan screenshot Anda: "KODE (NAMA)" -> contoh: "TABRDG (CT BAJERA)"
                     ...
                     <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="md:col-span-1">
                             ...
                             <div class="mt-4">
                                ...
                                <input type="text" name="approver_nik" value="{{ old('approver_nik', $maintenance->approver_nik) }}" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm py-2 px-3" placeholder="NIK Atasan">
                            </div>
                        </div>
                    </div>
                    {{-- Submit Buttons --}}

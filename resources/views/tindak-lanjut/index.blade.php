                        ...
                        <div class="flex flex-row flex-wrap gap-3">
                            ...
                            <div class="relative flex-1 min-w-[200px]">
                                ...
                                <input type="text" 
                                    ...
                                    placeholder="Cari lokasi, ruang, atau pelaksana..." 
                            ...
                            <div class="w-auto">
                                <select name="sort" 
                                        id="sortSelect"
                                        class="px-auto py-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-white text-sm text-gray-700 hover:bg-gray-50 transition">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 sm:p-6">
                    ...
                    <div id="contentContainer">
                        @include('tindak-lanjut.partials.table')
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function performSearch() {
        ...
        fetch(`{{ route('tindak-lanjut.index') }}?${params.toString()}`, {
            headers: {

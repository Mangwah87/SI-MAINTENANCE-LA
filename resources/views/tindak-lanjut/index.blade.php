                    ...
                    <form id="filterForm" class="space-y-4">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <div class="flex gap-2">
                                <select name="sort" 
                                        id="sortSelect"
                                        class="px-6 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-white text-sm text-gray-700 hover:bg-gray-50 transition">

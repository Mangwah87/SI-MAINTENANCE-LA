                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                                        Location *
                                        <span class="text-xs font-normal text-gray-500">(Lokasi Central)</span>
                                    </label>
                                            ...
                                            <optgroup label="AREA {{ $area }}">
                                                @foreach($centrals as $central)
                                                    <option value="{{ $central->id_sentral }} ({{ $central->nama }})"
                                                        {{ old('location', isset($maintenance) ? $maintenance->location : '') == $central->id_sentral . ' (' . $central->nama . ')' ? 'selected' : '' }}>
                                    ...
                                    <p class="mt-1 text-xs text-gray-600">Pilih lokasi central dari daftar yang tersedia</p>
                                    @error('location')

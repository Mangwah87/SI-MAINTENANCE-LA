...
<!-- 1. Visual Check (Physical Check) - UPDATED -->
<div class="mb-8">
    <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b pb-2">1. Physical Check</h3>
...
<div>
        ...
        <div class="border border-gray-200 rounded-lg p-4 bg-white">
            ...
            @endif
                         ...
                         <!-- d. Rectifier Module Installed (NEW) -->
        <div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end mb-4">
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        d. Rectifier Module Installed
                        <!-- <span class="text-yellow-500 font-semibold ml-1">⚠ NEW FIELD</span> -->
                    </label>
                    <input type="text" name="rectifier_module_installed"
                        value="{{ old('rectifier_module_installed', $maintenance->rectifier_module_installed ?? '') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-400"
                        placeholder="Enter rectifier module status">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Status</label>
                    <select name="status_rectifier_module_installed" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-400">
                        <option value="OK" {{ old('status_rectifier_module_installed', $maintenance->status_rectifier_module_installed ?? 'OK') == 'OK' ? 'selected' : '' }}>OK</option>
                        <option value="NOK" {{ old('status_rectifier_module_installed', $maintenance->status_rectifier_module_installed ?? '') == 'NOK' ? 'selected' : '' }}>NOK</option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                    <label class="block text-sm font-medium text-gray-700 mb-3">
                        <span class="inline-flex items-center gap-2">
                            ...
                            Foto Rectifier Module
                        </span>
                    </label>
                    <div id="camera-container-rectifier-module" class="space-y-3 mb-3"></div>
                    <button type="button" onclick="addCameraSlot('rectifier_module')"
                        class="w-full px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition text-sm font-medium">
                        + Tambah Foto
                    </button>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 bg-white">
                    ...
                    <input type="file" name="images_rectifier_module[]" multiple accept="image/jpeg,image/jpg,image/png"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-400 text-sm file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-gray-100 file:text-gray-700 hover:file:bg-gray-200"
                        onchange="handleImageUpload(this)">
                    <p class="text-xs text-gray-500 mt-2">Format: JPG, JPEG, PNG (Max: 5MB/file)</p>
                </div>
        ...
        <!-- e. Alarm Modul Rectifier (NEW) -->
        <div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end mb-4">
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        e. Alarm Modul Rectifier
                        <!-- <span class="text-yellow-500 font-semibold ml-1">⚠ NEW FIELD</span> -->
                    </label>
                    <input type="text" name="alarm_modul_rectifier"
                        value="{{ old('alarm_modul_rectifier', $maintenance->alarm_modul_rectifier ?? '') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-400"
                        placeholder="Normal = Green, Alarm = Red">
                    <p class="text-xs text-gray-600 mt-1 font-medium">Expected: Normal = Green | Alarm = Red</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Status</label>
                    <select name="status_alarm_modul_rectifier" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-400">
                        <option value="OK" {{ old('status_alarm_modul_rectifier', $maintenance->status_alarm_modul_rectifier ?? 'OK') == 'OK' ? 'selected' : '' }}>OK</option>
                        <option value="NOK" {{ old('status_alarm_modul_rectifier', $maintenance->status_alarm_modul_rectifier ?? '') == 'NOK' ? 'selected' : '' }}>NOK</option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                    ...
                    <div id="camera-container-alarm-modul" class="space-y-3 mb-3"></div>
                    <button type="button" onclick="addCameraSlot('alarm_modul')"
                        class="w-full px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition text-sm font-medium">
                        + Tambah Foto
                    </button>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 bg-white">
                    ...
                    <input type="file" name="images_alarm_modul[]" multiple accept="image/jpeg,image/jpg,image/png"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-400 text-sm file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-gray-100 file:text-gray-700 hover:file:bg-gray-200"
                        onchange="handleImageUpload(this)">
                    <p class="text-xs text-gray-500 mt-2">Format: JPG, JPEG, PNG (Max: 5MB/file)</p>
                </div>
...
<div class="mb-8 p-6">
    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-2">a. AC Input Voltage</label>
        ...
        <!-- REMOVED: Battery Temperature section -->

        <!-- d. Charging Voltage DC -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-2">d. Charging Voltage DC </label>
        ...
        <!-- e. Charging Current DC (formerly "f") -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-2">e. Charging Current DC (Max 10% Battery Capacity)</label>
                <input type="number" step="0.01" name="charging_current_dc" value="{{ old('charging_current_dc', $maintenance->charging_current_dc ?? '') }}"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="5.00">
                    <p class="text-xs text-gray-500 mt-1">
                        (Max 10% Battery Capacity ( AH )
                </p>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Status</label>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="mb-8 p-6">
                            ...
                            <div class="space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                                    <div class="md:col-span-2">
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Rectifier Switching test, from the main source (PLN)  to  back up mode, by turning off Rectifier input MCB</label>
                                        <input type="text" name="backup_test_rectifier" value="{{ old('backup_test_rectifier', $maintenance->backup_test_rectifier ?? '') }}"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                            placeholder="Rectifier Switching Test Result">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Status</label>

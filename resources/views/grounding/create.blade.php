        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('grounding.store') }}" method="POST" id="grounding-form">
                ...
                <div class="flex justify-center gap-4 py-6">
                    ...
                    <button type="submit" class="px-8 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white font-bold rounded-lg shadow-lg">Simpan Data</Batal>
                </div>
            </form>
        </div>
    </div>

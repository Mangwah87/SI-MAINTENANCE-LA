...
<head>
    ...
    <style>
        /* Kumpulan style glassmorphism yang sama dengan login */
        .glass-card {
        ...
        .glass-button-dark { background-color: rgba(30, 30, 226, 0.6); color: white; }
        .glass-button-dark:hover { background-color: rgba(15, 15, 158, 0.6); }

        .glass-text { color: white; }
        .glass-link { color: #1b81fe; }
        .glass-link:hover { color: #0b4197; }
    ...
    <div class="relative z-10 glass-card rounded-xl shadow-2xl max-w-md w-full p-6 text-white">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    <i data-lucide="user" class="absolute left-3 top-1/2 transform -translate-y-1/2 glass-icon w-5 h-5"></i>
            ...
            <div>
                <label for="password_confirmation" class="block text-sm font-medium glass-text mb-1">Konfirmasi Password</label>
                <div class="relative">
                    <i data-lucide="lock" class="absolute left-3 top-1/2 transform -translate-y-1/2 glass-icon w-5 h-5"></i>
            ...
            <button type="submit"
                ...
                <i data-lucide="user-plus" class="w-5 h-5 glass-icon"></i> Register
            </button>

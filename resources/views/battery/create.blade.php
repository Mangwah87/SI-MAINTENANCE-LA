                    ...
                    <div class="p-4 sm:p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="battery_type" id="main_battery_type" value="{{ old('battery_type', 'VRLA') }}"
                                    class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent"
                            ...
                            <div>
                                ...
                                <input type="text" name="end_device_batt" id="main_end_device_batt" value="{{ old('end_device_batt', '-') }}"
                                    class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent"
                    ...
                    <div class="p-4 sm:p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6">
                            <div>
                                ...
                                <input type="number" step="0.01" name="rectifier_test_backup_voltage" value="{{ old('rectifier_test_backup_voltage') }}"
                                    class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent"
                                    placeholder="49.00">
                            ...
                            <div>
                                ...
                                <select name="rectifier_test_backup_voltage_status"
                                    ...
                                    <option value="OK" {{ old('rectifier_test_backup_voltage_status') == 'OK' ? 'selected' : '' }}>OK</option>
                                    <option value="NOK" {{ old('rectifier_test_backup_voltage_status') == 'NOK' ? 'selected' : '' }}>NOK (Not OK)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6">
                            <div>
                                ...
                                <input type="number" step="0.01" name="rectifier_test_measurement_1" value="{{ old('rectifier_test_measurement_1') }}"
                                    class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent"
                                    placeholder="59.00">
                                <p class="mt-1 text-xs text-gray-500">Operational Standard: Min 49 VDC</p>
                            </div>
                            <div>
                                ...
                                <select name="rectifier_test_measurement_1_status"
                                    class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent">
                                    <option value="">-- Select Status --</option>
                                    <option value="OK" {{ old('rectifier_test_measurement_1_status') == 'OK' ? 'selected' : '' }}>OK</option>
                                    <option value="NOK" {{ old('rectifier_test_measurement_1_status') == 'NOK' ? 'selected' : '' }}>NOK (Not OK)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                ...
                                <input type="number" step="0.01" name="rectifier_test_measurement_2" value="{{ old('rectifier_test_measurement_2') }}"
                                    class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent"
                                    placeholder="48.00">
                            ...
                            <div>
                                ...
                                <select name="rectifier_test_measurement_2_status"
                                    class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent">
                                    <option value="">-- Select Status --</option>
                                    <option value="OK" {{ old('rectifier_test_measurement_2_status') == 'OK' ? 'selected' : '' }}>OK</option>
                                    <option value="NOK" {{ old('rectifier_test_measurement_2_status') == 'NOK' ? 'selected' : '' }}>NOK (Not OK)</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 sm:p-6">
                        <div class="space-y-4">
                            ...
                            <div class="border-2 border-gray-200 rounded-lg p-4">
                                <h4 class="text-md font-bold text-black-700 mb-3">Executor (Pelaksana)</h4>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 mb-2">Nama Lengkap</label>
                                            <input type="text" name="technician_4_name" value="{{ old('technician_4_name') }}"
                                                class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent"
                                                placeholder="Nama pelaksana 4">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 mb-2">Mitra / Internal</label>
                                            <input type="text" name="technician_4_company" value="{{ old('technician_4_company') }}"
                                                class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent"
                                                placeholder="Nama perusahaan">
                                        </div>
                                    </div>
                            ...
                            <!-- Verifikator -->
                            <div class="border-2 border-gray-200 rounded-lg p-4">
                                <h4 class="text-md font-bold text-black-700 mb-3">Verifikator</h4>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2">Nama Verifikator</label>
                                        <input type="text" name="verifikator_name" value="{{ old('verifikator_name') }}"
                                            class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent"
                                            placeholder="Nama yang memverifikasi">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2">NIM</label>
                                        <input type="text" name="verifikator_nim" value="{{ old('verifikator_nim') }}"
                                            class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent"
                                            placeholder="Nomor Identitas Verifikator">
                                    </div>
                                    <!-- <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2">Mitra / Internal</label>
                                        <input type="text" name="verifikator_company" value="{{ old('verifikator_company') }}"
                                            class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent"
                            ...
                            <div class="border-2 border-gray-200 rounded-lg p-4">
                                <h4 class="text-md font-bold text-black-700 mb-3">Head of Sub Department</h4>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2">Nama Kepala Sub Departemen</label>
                                        <input type="text" name="head_of_sub_dept" value="{{ old('head_of_sub_dept') }}"
                                            class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent"
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2">NIM</label>
                                        <input type="text" name="head_of_sub_dept_nim" value="{{ old('head_of_sub_dept_nim') }}"
                                            class="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent"
            ...
            div.innerHTML = `
                ...
                <div class="grid grid-cols-1 sm:grid-cols-4 gap-3 sm:gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="readings[${index}][voltage]" required min="0" max="100" placeholder="13.8"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="readings[${index}][soh]" min="0" max="100" placeholder="95.5"
                               class="w-full px-2 sm:px-3 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent">
                        ...
                        if (navigator.geolocation) {
                            ...
                            navigator.geolocation.getCurrentPosition(
                                ...
                                function(error) {
                                    ...
                                    uploadedPreview.classList.remove('hidden');
                                    document.querySelector(`input[data-photo="${index}"]`).value = imageData;
                                    photoInfo.innerHTML = '<p class="text-yellow-600">Foto diupload tanpa data GPS</p>';
                                },

                ...
                <div class="p-4 sm:p-6 text-gray-900">
                    ...
                    <div class="mb-6 sm:mb-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="bg-gray-50 p-3 sm:p-4 rounded-lg">
                                <label class="block text-xs sm:text-sm font-medium text-gray-600 mb-1">Date / Time</label>
                                <p class="text-sm sm:text-base font-semibold text-gray-900">{{ $inverter->tanggal_dokumentasi ? \Carbon\Carbon::parse($inverter->tanggal_dokumentasi)->format('d M Y, H:i') : '-' }}</p>
                            </div>
                            <div class="bg-gray-50 p-3 sm:p-4 rounded-lg">
                            ...
                            <div class="bg-gray-50 p-3 sm:p-4 rounded-lg">
                                <label class="block text-xs sm:text-sm font-medium text-gray-600 mb-1">Perusahaan</label>
                                <p class="text-sm sm:text-base font-semibold text-gray-900">{{ $inverter->perusahaan ?? '-' }}</p>
                            </div>
                            <div class="bg-gray-50 p-3 sm:p-4 rounded-lg">
                                <label class="block text-xs sm:text-sm font-medium text-gray-600 mb-1">Pelaksana</label>
                                <p class="text-sm sm:text-base font-semibold text-gray-900">{{ $inverter->boss ?? '-' }}</p>
                            </div>
                    ...
                    <div class="mb-6 sm:mb-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            @if(is_array($inverter->pelaksana) && count($inverter->pelaksana) > 0)
                                @foreach($inverter->pelaksana as $index => $pelaksana)
                                <div class="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-200">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <h5 class="font-semibold text-sm text-gray-700">Pelaksana {{ $index + 1 }}</h5>
                                    </div>
                                    <div class="space-y-2 text-sm">
                                        <div>
                                            <span class="text-gray-600 block text-xs">Nama:</span>
                                            <span class="font-semibold text-gray-900">{{ $pelaksana['nama'] ?? '-' }}</span>
                                        </div>
                                        <div>
                                            <span class="text-gray-600 block text-xs">Perusahaan:</span>
                                            <span class="text-gray-900">{{ $pelaksana['perusahaan'] ?? '-' }}</span>
                                        </div>
                                    </div>
                                </div>
                                @endforeach

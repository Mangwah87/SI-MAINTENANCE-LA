            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-6">
                ...
                <a href="{{ route('battery.index') }}" class="block h-full">
                    <div class="bg-white rounded-2xl p-6 shadow-lg border-2  h-full min-h-[180px] flex flex-col items-center justify-center hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group">
                        ...
                        <span class="text-sm sm:text-base font-semibold text-black text-center leading-tight">Maintenance Battery</span>
                    </div>
                </a>
                ...
                <a href="{{ route('genset.index') }}" class="block h-full">
                    <div class="bg-white rounded-2xl p-6 shadow-lg border-2  h-full min-h-[180px] flex flex-col items-center justify-center hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group">
                        ...
                        <span class="text-sm sm:text-base font-semibold text-black text-center leading-tight">Maintenance Genset</span>
                    </div>
                </a>
                ...
                <a href="{{ route('ups1.index') }}" class="block h-full">
                    <div class="bg-white rounded-2xl p-6 shadow-lg border-2  h-full min-h-[180px] flex flex-col items-center justify-center hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group">
                        ...
                        <span class="text-sm sm:text-base font-semibold text-black text-center leading-tight">Maintenance 1 Phase UPS</span>
                    </div>
                </a>
                ...
                <a href="{{ route('ups3.index') }}" class="block h-full">
                    <div class="bg-white rounded-2xl p-6 shadow-lg border-2  h-full min-h-[180px] flex flex-col items-center justify-center hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group">
                        ...
                        <span class="text-sm sm:text-base font-semibold text-black text-center leading-tight">Maintenance 3 Phase UPS</span>
                    </div>
                </a>
                ...
                <a href="{{ route('ac.index')}}" class="block h-full">
                    <div class="bg-white rounded-2xl p-6 shadow-lg border-2  h-full min-h-[180px] flex flex-col items-center justify-center hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group">
                        ...
                        <span class="text-sm sm:text-base font-semibold text-black text-center leading-tight">Maintenance AC</span>
                    </div>
                </a>
                ...
                <a href="{{ route('pm-permohonan.index') }}" class="block h-full">
                    <div class="bg-white rounded-2xl p-6 shadow-lg border-2  h-full min-h-[180px] flex flex-col items-center justify-center hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group">
                        <div class="mb-4 transform group-hover:scale-110 transition-transform duration-300">
                            <i data-lucide="arrow-up-wide-narrow" class="w-12 h-12 text-blue-600"></i>
                        </div>
                        <span class="text-sm sm:text-base font-semibold text-black text-center leading-tight">Permohonan Tindak Lanjut Preventive Maintenance</span>
                    </div>
                </a>
                ...
                <a href="{{ route('schedule.index') }}" class="block h-full">
                    <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 shadow-lg border-2 border-blue-400 h-full min-h-[180px] flex flex-col items-center justify-center hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group">
                        ...
                        <span class="text-sm sm:text-base font-semibold text-black text-center leading-tight">Jadwal PM Sentral</span>
                    </div>
                </a>
                ...
                <a href="#" class="block h-full">
                    <div class="bg-white rounded-2xl p-6 shadow-lg border-2  h-full min-h-[180px] flex flex-col items-center justify-center hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group">
                        ...
                        <span class="text-sm sm:text-base font-semibold text-black text-center leading-tight">PM Inverter -48VDC-220VAC</span>
                    </div>
                </a>
                ...
                <a href="{{ route('pm-shelter.index') }}" class="block h-full">
                    <div class="bg-white rounded-2xl p-6 shadow-lg border-2  h-full min-h-[180px] flex flex-col items-center justify-center hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group">
                        ...
                        <span class="text-sm sm:text-base font-semibold text-black text-center leading-tight">Preventive Maintenance Ruang Shelter</span>
                    </div>
                </a>
                ...
                <a href="{{ route('grounding.index') }}" class="block h-full">
                    <div class="bg-white rounded-2xl p-6 shadow-lg border-2  h-full min-h-[180px] flex flex-col items-center justify-center hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group">
                        ...
                        <span class="text-sm sm:text-base font-semibold text-black text-center leading-tight">PM Petir dan Grounding</span>
                    </div>
                </a>
